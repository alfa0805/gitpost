...
function Cities() {
  ...
  const url ="https://realauto.limsa.uz/api/cities"
            ...
            key={category.id}>
                <div className="w-[270x] h-[250px] rounded-md">
                  <img className="w-full h-full object-cover rounded-md"
                      src={`${imgUrl}/${category.image_src}`} alt={category.name}
                    />
                </div>
                <h2 className="text-white text-center text-xl font-medium py-3 hover:text-[#03e2ff]">{category.name}</h2>
                <div 
