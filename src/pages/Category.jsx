...
function Category() {
    ...
    const handleAddCategory = () => {
        ...
        axios({
            url: editingItem?`https://realauto.limsa.uz/api/categories/${editingItem.id}` : 'https://realauto.limsa.uz/api/categories',
    ...
    const deleteCategory = (id) => {
        setLoading(true)
        axios({
            url: `https://realauto.limsa.uz/api/categories/${id}`,
            method: 'DELETE',
            headers: {
                Authorization: `Bearer ${token}`,
            },
            ...
            toast.error("Qayta urinib ko‘ring!");
        }).finally(() =>{
            setLoading(false)
        })
    };
